...
<body>
	<div id="logreg-forms">
		<form action="MainController" class="form-signup" id="formSignUp" method="POST">
	...
	<script>
		...
		btnSignUp.addEventListener("click", function(event) {
			...
			var txtFullname = document.getElementById("txtFullname").value.trim();
			var txtEmail = document.getElementById("txtEmail").value.trim();
			var txtPhoneNumber = document.getElementById("txtPhoneNumber").value.trim();
			var txtPassword = document.getElementById("txtPassword").value;
			var txtConfirmPassword = document.getElementById("txtConfirmPassword").value;
			var txtAddress = document.getElementById("txtAddress").value.trim();
			if (txtFullname === "") {
				btnSignUp.setAttribute("data-target", "#errorModal");
