	...
	<div class="container">
		<form class="form-horizontal" role="form">
			...
			<div class="col-sm-12">
				<div class="row">
					<div class="col-sm-4">
						<label for="firstName" class="form-group">Email (<span>*</span>)
						</label>
					</div>
					<div class="col-sm-8">
			...
			<div class="col-sm-12">
				<div class="row">
					...
					<div class="col-sm-8">
						<textarea type="text" id="address" placeholder="Address"
							class="form-control" autofocus cols="20" rows="3"></textarea>
					</div>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-sm-6 form-group to">
						<button class="btn facebook-btn social-btn" type="button"
							class="form-control">Sign in with Facebook</button>
					</div>
					<div class="col-sm-6 form-group">
						<button class="btn google-btn social-btn" type="button"
							class="form-control">Sign in with Google+</button>
					</div>
				</div>
			</div>
		</form>
