        ...
        <body>
            <div id="logreg-forms">
                ...
                <form action="#" class="form-signup">
                    <h1 class="h3 mb-3 font-weight-normal" style="text-align: center">Sign Up
                    </h1>
                    ...
                    <input type="text" id="txtFullname" class="form-control" placeholder="Full name" name="txtFullname"> <input type="email" id="txtEmail" class="form-control" placeholder="Email address" name="txtEmail"> <input type="text" id="txtPhoneNumber"
                        class="form-control" placeholder="Phone number" name="txtPhoneNumber"> <input type="password" id="txtPassword" class="form-control" placeholder="Password" name="txtPassword"> <input type="password" id="txtConfirmPassword" class="form-control"
                        placeholder="Confirm Password" name="txtConfirmPassword"> <input type="text" id="txtAddress" class="form-control" placeholder="Address" name="txtAddress">


                    <button class="btn btn-primary btn-block" type="button" id="btnSignUp">
