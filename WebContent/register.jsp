    ...
    <div class="container">
        <form class="form-horizontal" role="form">
            ...
            <div class="col-sm-12">
                <div class="row">
                    <div class="col-sm-4">
                        <label for="firstName" class="form-group">Email (<span>*</span>)</label>
                    </div>
                    <div class="col-sm-8">
            ...
            <div class="col-sm-12">
                <div class="row">
                    <div class="col-sm-4">
                        <label for="password" class="form-group">Password (<span>*</span>)</label>
                    </div>
                    <div class="col-sm-8">
            ...
            <div class="col-sm-12">
                <div class="row">
                    <div class="col-sm-4">
                        <label for="password" class="form-group">Confirm Password(<span>*</span>)</label>
                    </div>
                    <div class="col-sm-8">
            ...
            <div class="col-sm-12">
                <div class="row">
                    <div class="col-sm-4">
                        <label for="firstName" class="form-group">Phone Number (<span>*</span>)</label>
                    </div>
                    <div class="col-sm-8">
            ...
            <div class="col-sm-12">
                <div class="row">
                    <div class="col-sm-4">
                        <label for="firstName" class="form-group">Full Name (<span>*</span>)</label>
                    </div>
                    <div class="col-sm-8">
            ...
            <div class="col-sm-12">
                <div class="row">
                    <div class="col-sm-4">
                        <label for="firstName" class="form-group">Address (<span>*</span>)</label>
                    </div>
                    <div class="col-sm-8">
                        <textarea type="text" id="address" placeholder="Address" class="form-control" autofocus
            ...
            <div class="form-group">
                <div class="col-sm-12">
                    <div class="checkbox">
                        <label>
                            <input type="checkbox">I accept the <a href="#">terms</a> of User & Privacy Policy
                        </label>
                    </div>
                </div>
            </div>
